...
4. Include a `.calculator-box` with a unit toggle at the top: two buttons labeled "Imperial (US)" and "Metric". Active toggle button uses `background:#0066cc;color:#fff`. Inactive uses `background:#fff;border:1px solid #ccc;color:#1a1a1a`. Switching must swap input labels and recalculate using metric formula when Metric is selected. Default to Imperial.
